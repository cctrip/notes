...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/notes/flexsearch.min.js');loadScript('/notes/en.search-data.min.05ae8dd3c589ee1665203f48ce3372321452d61b68958536b227a05f9224271d.js',function(){input.required=false;search();});}
