...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/notes/flexsearch.min.js');loadScript('/notes/en.search-data.min.5129dbb439111296289080a04a227d89dc445afe50382137fdb890573db2fa8f.js',function(){input.required=false;search();});}
