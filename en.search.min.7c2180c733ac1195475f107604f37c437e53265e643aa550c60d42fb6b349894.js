...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/notes/flexsearch.min.js');loadScript('/notes/en.search-data.min.0b89783618dd3e514de5d8a2bc86e662ee7a7e9a2dac00e28486221358a45ae4.js',function(){input.required=false;search();});}
