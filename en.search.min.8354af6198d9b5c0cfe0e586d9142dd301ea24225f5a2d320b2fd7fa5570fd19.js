...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/notes/flexsearch.min.js');loadScript('/notes/en.search-data.min.d91898e5078aca339d79d33057c562bfcc7d147b904252b613015a3b40e41bf8.js',function(){input.required=false;search();});}
