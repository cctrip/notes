...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/notes/flexsearch.min.js');loadScript('/notes/en.search-data.min.5039be71ee46414a713092290cdb3d78380786186029c0e798fbaee8c005f95c.js',function(){input.required=false;search();});}
