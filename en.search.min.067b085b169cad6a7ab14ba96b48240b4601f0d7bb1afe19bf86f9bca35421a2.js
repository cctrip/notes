...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/notes/flexsearch.min.js');loadScript('/notes/en.search-data.min.049ce14a5b1667ed557a3b8d2bb6cd4df04e05ae47537965fc4ba627193faf2c.js',function(){input.required=false;search();});}
