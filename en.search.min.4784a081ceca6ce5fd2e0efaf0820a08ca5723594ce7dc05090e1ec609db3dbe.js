...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/notes/flexsearch.min.js');loadScript('/notes/en.search-data.min.e80592ae0e1066d76d2ef13e128ba5d8db7d3b1bfd3168ee0aa62dd88be9b4c7.js',function(){input.required=false;search();});}
