...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/notes/flexsearch.min.js');loadScript('/notes/en.search-data.min.b694703b5d7ca99117fd4b011b778ae7e13ee6c0a531cef402a7c999e98a09d0.js',function(){input.required=false;search();});}
