...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/notes/flexsearch.min.js');loadScript('/notes/en.search-data.min.f7c030c3f6d5851dafef97b5a1cd641d0f89117ecef6dfc41429def0ed4d143c.js',function(){input.required=false;search();});}
