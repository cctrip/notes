...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/notes/flexsearch.min.js');loadScript('/notes/en.search-data.min.f61b9487a20c7e164d52c1e08bcc7bd541dce3b97cd1522843b72eae104e909e.js',function(){input.required=false;search();});}
