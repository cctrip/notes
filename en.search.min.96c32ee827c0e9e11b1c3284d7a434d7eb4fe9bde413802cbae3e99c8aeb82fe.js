...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/notes/flexsearch.min.js');loadScript('/notes/en.search-data.min.2dba17b66f001c07548d60a5c15e654da1be527949f960e82fcdee1e5ecb8548.js',function(){input.required=false;search();});}
