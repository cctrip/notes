...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/notes/flexsearch.min.js');loadScript('/notes/en.search-data.min.f75f311cc0f055fa2fd29a2f651631c2ed540bc9e7a4af6c38093d485560f311.js',function(){input.required=false;search();});}
