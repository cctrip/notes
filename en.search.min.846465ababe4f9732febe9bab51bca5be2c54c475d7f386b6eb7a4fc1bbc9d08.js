...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/notes/flexsearch.min.js');loadScript('/notes/en.search-data.min.4dcfc380d0c2941bb30527330878586d2745da7fa34a8c0a0a6ce2a1906d7a26.js',function(){input.required=false;search();});}
