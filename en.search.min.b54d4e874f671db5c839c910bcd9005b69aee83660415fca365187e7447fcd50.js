...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/notes/flexsearch.min.js');loadScript('/notes/en.search-data.min.f2dfb2e7af5b957daa2f3b7e5acacc404b55848ecb5bdb45aa26782e88bf1bf5.js',function(){input.required=false;search();});}
