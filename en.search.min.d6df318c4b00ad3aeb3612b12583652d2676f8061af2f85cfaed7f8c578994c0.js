...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/notes/flexsearch.min.js');loadScript('/notes/en.search-data.min.6e238f31cf580d9425e8431647e8c272a199ce34758a9e242d8d2c7f09bb245c.js',function(){input.required=false;search();});}
