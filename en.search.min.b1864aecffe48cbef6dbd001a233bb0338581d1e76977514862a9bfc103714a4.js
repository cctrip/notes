...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/notes/flexsearch.min.js');loadScript('/notes/en.search-data.min.3d020b12200d2b7e0d866058197a62fa4b831017902fff5dfbb075b25f73040f.js',function(){input.required=false;search();});}
