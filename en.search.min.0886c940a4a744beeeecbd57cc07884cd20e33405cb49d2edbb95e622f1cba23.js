...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/notes/flexsearch.min.js');loadScript('/notes/en.search-data.min.5e06e4a25be7b42bf7ddd45886732ceb35d958e9399a99efa515911c9fbf6af9.js',function(){input.required=false;search();});}
