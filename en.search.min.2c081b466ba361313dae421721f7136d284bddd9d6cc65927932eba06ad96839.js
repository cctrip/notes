...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/notes/flexsearch.min.js');loadScript('/notes/en.search-data.min.77cbfffbfd89df0b0cdf164d5730acd0ce7c1729f5b30284fdd93f3043ab9dfb.js',function(){input.required=false;search();});}
