...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/notes/flexsearch.min.js');loadScript('/notes/en.search-data.min.2df603ada8d7d44de84ce10820ed97ad0e9a7cf70c056c763cd062ec6cd6bbf0.js',function(){input.required=false;search();});}
