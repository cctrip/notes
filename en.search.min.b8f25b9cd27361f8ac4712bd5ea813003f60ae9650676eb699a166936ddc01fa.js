...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/notes/flexsearch.min.js');loadScript('/notes/en.search-data.min.c5819cfd20dfb8549d5a52d2ca26c68a50dce39b67b439a7b012d2dc8ec7ddd3.js',function(){input.required=false;search();});}
