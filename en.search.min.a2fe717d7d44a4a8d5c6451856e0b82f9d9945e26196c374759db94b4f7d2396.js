...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/notes/flexsearch.min.js');loadScript('/notes/en.search-data.min.3d62c1dfc15f4e764cae23adc997a1dafb78bcd52c0e7490f73b7d464eaba4d2.js',function(){input.required=false;search();});}
