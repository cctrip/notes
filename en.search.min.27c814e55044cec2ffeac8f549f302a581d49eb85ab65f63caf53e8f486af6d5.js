...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/notes/flexsearch.min.js');loadScript('/notes/en.search-data.min.20528606b45357753db38fb0fc39676e652ac3e10b4547b9860c5fbb2746dabd.js',function(){input.required=false;search();});}
