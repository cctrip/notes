...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/notes/flexsearch.min.js');loadScript('/notes/en.search-data.min.22fbb99647ceed8db53fe8630d3477fe0722f3a4f8a4b6e3cf94e845107dbc2d.js',function(){input.required=false;search();});}
