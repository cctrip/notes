...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/notes/flexsearch.min.js');loadScript('/notes/en.search-data.min.bf1a48afbf12b76866b6cd694be087d8b3d43a244669bdce038c4f5af5412f7e.js',function(){input.required=false;search();});}
