...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/notes/flexsearch.min.js');loadScript('/notes/en.search-data.min.3d8bad91bfba8e2bceeb56efaeceea422a609607efd9d6ec51aa5a43f66b153a.js',function(){input.required=false;search();});}
