...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/notes/flexsearch.min.js');loadScript('/notes/en.search-data.min.25f5a5a5b9b76ce508d38b7bf61cdda40a8388a995cd25df10d0f939808f2a9b.js',function(){input.required=false;search();});}
