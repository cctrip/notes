...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/notes/flexsearch.min.js');loadScript('/notes/en.search-data.min.9140993956f75283cfcb335c03312041ce172d9cf85fdab772fb77c1d9fbb332.js',function(){input.required=false;search();});}
